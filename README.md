...
- [Prezentare Vizuală (Screenshots)](#prezentare-vizuală-screenshots)
- [Funcționalități Detaliate & Logica de Business](#funcționalități-detaliate--logica-de-business)
  - [1. Autentificare & Securitate](#1-autentificare--securitate)
  - [2. Profil, Media & Galerie](#2-profil-media--galerie)
  - [3. GPS & Proximitate](#3-gps--proximitate)
    - [3.1. Deep Dive: Permisiunile de Locație și Integrarea OS](#31-deep-dive-permisiunile-de-locație-și-integrarea-os)
      - [A. Fluxul tehnic complet](#a-fluxul-tehnic-complet)
      - [B. Calcul distanță — formula geodezică](#b-calcul-distanță--formula-geodezică)
      - [C. Permisiuni necesare](#c-permisiuni-necesare)
      - [D. Fluxul de Consimțământ (Consent Flow)](#d-fluxul-de-consimțământ-consent-flow)
    - [3.2. De ce funcționează greu GPS-ul pe Emulator?](#32-de-ce-funcționează-greu-gps-ul-pe-emulator)
  - [4. Algoritmul de Social Matching (Swipe & Match)](#4-algoritmul-de-social-matching-swipe--match)
    - [A. Mecanica de Swipe](#a-mecanica-de-swipe)
    - [B. Generarea automată a Match-urilor](#b-generarea-automată-a-match-urilor)
    - [C. Fluxul Match → Chat](#c-fluxul-match-→-chat)
  - [5. Chat & Mesagerie](#5-chat--mesagerie)
  - [6. Funcționalități AI (AI Matchmaking Engine & Icebreaker)](#6-funcționalități-ai-ai-matchmaking-engine--icebreaker)
    - [A. Arhitectura Subsistemului AI](#a-arhitectura-subsistemului-ai)
    - [B. AI Picks (Recomandări de Compatibilitate)](#b-ai-picks-recomandări-de-compatibilitate)
    - [C. AI Icebreaker](#c-ai-icebreaker)
  - [7. Siguranță și Moderare (Block & Report)](#7-siguranță-și-moderare-block--report)
    - [A. Funcția de Blocare (Block User)](#a-funcția-de-blocare-block-user)
    - [B. Funcția de Raportare (Report User)](#b-funcția-de-raportare-report-user)
- [Arhitectură Tehnică & Stack](#arhitectură-tehnică--stack)
- [Structura proiectului](#structura-proiectului)
- [Referință API](#referință-api)
  - [Autentificare](#autentificare)
  - [Profiluri & Media](#profiluri--media)
  - [Swipe, Match & Locație](#swipe-match--locație)
  - [Chat & Raportare](#chat--raportare)
- [Ghid de instalare & testare locală](#%EF%B8%8F-ghid-de-instalare--testare-locală)
  - [Cerințe](#cerințe)
  - [1. Backend Django](#1-backend-django)
  - [2. Frontend Flutter](#2-frontend-flutter)
  - [Testare pe emulator Android — bridge 10.0.2.2](#testare-pe-emulator-android--bridge-10022)
- [Echipa de Dezvoltare](#-echipa-de-dezvoltare)
